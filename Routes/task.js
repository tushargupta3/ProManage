...
router.delete("/delectTask/:taskId",verifyToken,taskController.deleteTask);
router.get("/shareTask/:taskId",verifyToken,taskController.shareTask);

router.patch("/updateTaskSection/:taskId",verifyToken,taskController.updateTaskSection);
router.patch("/updateChecklistChecked/:taskId",verifyToken,taskController.updateChecklistChecked);
